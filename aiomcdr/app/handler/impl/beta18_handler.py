...
class Beta18Handler(VanillaHandler):
    ...
    def parse_player_left(self, info: Info):
        ...
        if info.is_from_server and parse.parse("{name} lost connection: {}", info.content) is not None:
